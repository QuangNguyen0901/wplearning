...
/*------------[ Cart ]-------------*/
if ( ! function_exists( 'mts_cart_button' ) ) {
                ...
                <?php if ( $cart_contents_count != '0' ) { ?>
                            ...
                            if ($i <= $cart_products_limit || ($i == $cart_products_limit+1 && $i == $items_count)) { // account for 1 remaining: show it normally
                                ...
                                <tr class="mts-cart-row">
                                    <td class="mts-cart-product">
                                        ...
                                        <?php echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf( '<a href="%s" class="remove" title="%s">&times;</a>', esc_url( wc_get_cart_remove_url( $cart_item_key ) ), __( 'Remove this item', 'mythemeshop' ) ), $cart_item_key ); ?>
                                    </td>
                                    <td class="mts-cart-price">
                                        <?php echo wc_price( $cart_item_data->get_price() ); ?>
                    ...
                    if ($remaining_items) {
                        ...
                        <tr class="mts-cart-row more-items">
                            <td class="mts-cart-product">
                                <a href="<?php echo esc_url( wc_get_cart_url() ); ?>"><?php echo sprintf( __( "[%s &times; ...]", 'mythemeshop' ), $remaining_items ); ?></a>
                            </td>
                            <td class="mts-cart-price">
                                <?php echo wc_price( $remaining_price ); ?>
                            </td>
                        </tr>
                        <?php
                    }
                    ...
                    <div class="mts-cart-content-footer clearfix">
                        ...
                        <a href="<?php echo esc_url( wc_get_checkout_url() ) ?>" class="button mts-cart-button"><?php _e( 'Checkout', 'mythemeshop' ); ?></a>
                        <a href="<?php echo esc_url( wc_get_cart_url() ) ?>" class="button mts-cart-button"><?php _e( 'Cart', 'mythemeshop' ); ?></a>
                    </div>
                <?php } ?>
                </div>
            </div>
...
if ( ! function_exists('mts_the_postinfo_item' ) ) {
    function mts_the_postinfo_item( $item ) {
        switch ( $item ) {
            ...
            case 'comment':
            ?>
                <span class="thecomment"><i class="fa fa-comments"></i> <a rel="nofollow" href="<?php echo esc_url( get_comments_link() ); ?>"><?php comments_number();?></a></span>
            <?php
            break;
        }
    }
